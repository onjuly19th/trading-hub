...
public class PerformanceMonitor {
    ...
    // 주문 관련 서비스 메서드 포인트컷
    @Pointcut("execution(* com.tradinghub.domain.order.OrderService.*(..))")
     ...
     * OrderService.executeOrder 메서드의 경우 실패 시 상세 로깅을 수행합니다.
     */
    ...
    public Object monitorPerformance(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            // OrderService.executeOrder 메서드인 경우 상세 로깅 추가
            if (className.equals("com.tradinghub.domain.order.OrderService") 
